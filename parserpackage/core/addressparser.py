...
if __name__ == '__main__':
    a = AddressParser()
    address = ["JL DAAN MOGOT KM 145 PESAKIH RT 3 RW 14, DURI KOSAMBI KOTA ADM. JAKARTA BA",
                "JL BAREK MOTOR NO 51 RT 01.08 KAB BINTAN,BINTAN TIMUR KEPRI KAB. BINTAN",
                "JL DR DJUNJUNAN NO 143  149  BTC FASHION BANDUNG KOTA BANDUNG",
                "BESUK RT 10 RW 04 DS SAMBUNGREJO KEC SUKODONO SIDOARJO KAB. SIDOARJO",
                "JL MALEBER UTARA NO 27.187 B RT 002.008 KOTA BANDUNG"]
    for i in address:
        print(a.parse_address(i))