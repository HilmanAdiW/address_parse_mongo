...
while counter < 4:   # set the batch
    ...
    df = pd.read_csv(r'C:\Users\Lenovo\Downloads\Telegram Desktop\alamat penerima januari reg 4 5.csv', header=None, names=['al_penerima'], skiprows=start, nrows=batch_size)
