...
while counter < 4:   # set the batch
    ...
    df = pd.read_csv('C:\\Users\\die_zer0\\hilman\\Data acquistion system\\alamat penerima januari reg 4 5.csv', header=None, names=['al_penerima'], skiprows=start, nrows=batch_size)
